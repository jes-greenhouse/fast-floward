    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"
          description="Sell a market item on the Kitty Items Marketplace"
          action="kittyItemsMarketSellMarketItem"
          method="post"
        ...
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item"
          ...
          action="kittyItemsMarketBuyMarketItem" 
          method="post"
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs"
          description="Read ID list of Kitty Items that are for sale" 
          action="kittyItemsMarketReadSaleCollectionIDs" 
          method="get"
          fields="marketCollectionAddress">
