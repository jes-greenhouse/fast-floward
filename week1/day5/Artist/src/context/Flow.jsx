        ...
        fcl.transaction`
          ...
          transaction(listingIndex: Int) {
            prepare(account: AuthAccount) {
              ...
              let tokenVault <- account.borrow<&FungibleToken.Vault>(from: /storage/flowTokenVault)!.withdraw(amount: listing.price)
  
              marketRef.buy(listing: listingIndex, with: <- tokenVault , buyer: account.address)
            }
          }
        `,
        fcl.args([
